...
<div class="col-md-6 panel" style="background-image:url(https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Cloud%2Cpasur.jpg/640px-Cloud%2Cpasur.jpg); min-height:430px;">
...
<div class="col-md-10">
<a href="mailto:nosabar666@gmail.com" style="color:#000000">no666@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/logo.png" width=100 height=100 alt="Hari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Kuis</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+6281284128844</h4>
		<h4 style="font-family:'typo' ">Kuis</h4>
		<h4 style="font-family:'typo' ">Sekolah Tinggi Teknologi Informasi</h4></div></div>
		</p>
      </div>
